...
from transformers import RobertaForTokenClassification, AutoTokenizer, AutoModelForCausalLM
...
class EnsembleModel(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        logits_list = []
        for p_g,p_q,p_r,p_l,p_p in zip(pred_gemma, pred_qwen, pred_roberta, pred_llama, pref_pred):
            p_sum = p_g+p_q+p_r+p_l
            if p_sum==th:
